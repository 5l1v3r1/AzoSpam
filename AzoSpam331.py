...
unical_guid = "353E77DF-928B-4941-A631-512662F0785A3061-4E40-BBC2-3A27F641D32B-54FF-44D7-85F3-D950F519F12F353E77DF-928B-4941-A631-512662F0785A3061-4E40-BBC2-3A27F641D32B-54FF-44D7-85F3-D950F519F12F"

xor_key = chr(3) + chr(85) + chr(174)
...
def write_outputfile():
    # Info part:
    outputfile = ""
    outputfile += glob_guid + "|" + glob_windowsversion[1] + "|" + glob_windowsversion[0] + "|"
	...
	#IPAPI Part
    outputfile += unical_guid
    outputfile += glob_ip + ":" + glob_countrycode
...
def create_fakecredentials():
    ...
    while i <= number_credentials:
        ...
        # soft = "(111,(select concat(19,0x3a,3,0x3a,substring(filename, 51, 25)) from reports where r_id=19),333,4,5,6,7) --"
...
while i < fake_reports:
    try:
        ...
        print("[" + str(datetime.datetime.now()) + "]" + "[" + str(i) + " / " + str(fake_reports) + "] Report sent to " + url)
        print reply.read()
        time.sleep(5)
        i = i + 1
